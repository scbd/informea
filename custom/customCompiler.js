$C('$data.storageProviders.Custom.CustomCompiler', $data.Expressions.EntityExpressionVisitor, null, {
    ...
    VisitOrderExpression: function (expression, context) {
        ...
        context.data = "";
        context.lambda = "";
        var funcCompiler = Container.createCustomFunctionCompiler(this.provider);
